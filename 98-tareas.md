...
<img src="98-tareas_files/figure-html/unnamed-chunk-38-1.png" width="672" />
...
<img src="98-tareas_files/figure-html/unnamed-chunk-40-1.png" width="672" />
...
<img src="98-tareas_files/figure-html/unnamed-chunk-42-1.png" width="672" />
...
en donde el total de votos para el $j$-ésimo candidato en la $k$-ésima casilla del estrato $i$ se modela como:
...
Las columnas que debes usar son:

* `distrito_loc_17`: para determinar los estratos.
* `ln_total`: para el tamaño de la lista nominal en cada casilla.
* `pri_pvem:otros`: para calcular el total de votos por partido en cada casilla.
